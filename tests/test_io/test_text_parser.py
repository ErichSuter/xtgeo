...
def test_iter_nonempty_noncomment_lines_skips_configured_comment_prefixes() -> None:
    stream = io.StringIO("\n  \n# comment\nVRTX 1 0.0 0.0 0.0 CNXYZ\nTRGL 1 2 3\n")

    result = list(TextParser.iter_nonempty_noncomment_lines(stream, ["#"]))
...
def test_iter_nonempty_noncomment_lines_only_uses_configured_prefixes() -> None:
